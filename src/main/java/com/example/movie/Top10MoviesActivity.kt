...
import com.example.movie.adapter.Top10Adapter
...
class Top10MoviesActivity : AppCompatActivity() {

    private var adapter: Top10Adapter? = null
    ...
    private fun <T> LiveData<T>.observe(observe: (T?) -> Unit) =
        observe(this@Top10MoviesActivity, Observer { observe(it) })
